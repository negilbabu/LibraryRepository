...
const routes: Routes = [
  ...
  {path: 'user-reg',component:UserRegComponent,canActivate: [HomeguardGuard]},
  ...
  {path : 'booksdisplay',component:BooksdisplayComponent,canActivate: [HomeguardGuard]},
  ...
  {path : 'borrowhistory',component:BorrowhistoryComponent,canActivate: [HomeguardGuard]},
  {path : 'view-profile',component:ViewProfileComponent},
  {path : 'findby-category',component:FindbyCategoryComponent,canActivate: [HomeguardGuard]},
  {path : 'notification',component:NotificationComponent,canActivate: [HomeguardGuard]},
