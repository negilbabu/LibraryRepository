...
public class csvUpload { public static enum Status {
    INACTIVE((byte) 0),
    ACTIVE((byte) 1);
...
public csvUpload(String booksName,String publication, String booksAuther, Integer booksCopies,Integer categoryId,Integer status) {
