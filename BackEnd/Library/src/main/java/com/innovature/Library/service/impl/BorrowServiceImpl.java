...
//mail//
    ...
    //     @Override
    // @Transactional
    // public void sendEmail(Integer userId,String subject,String text){
    //     //String to = userRepository.findEmailById(userId);
    ...
    // @Override
    // public Collection<Borrow> listAll(){
    //     Collection<Borrow> borrows=new ArrayList<Borrow>();
    //     borrows=borrowRepository.findAll();
    //     Collection<BorrowListView> borrowlists=new ArrayList<BorrowListView>();
    //     for (Borrow borrow:borrows)
    //     {
    //         // int booksId=borrow.getBooksId();
    ...
    //         User userId=borrow.getUser();
    //         User user=userRepository.findById(userId);

    //         BorrowListView borrowView=new BorrowListView(borrow.getBorrowId(),user.getUserId(),books.getBooksId(),books.getBooksName(booksId),borrow.getDueDate(),borrow.getReturnDate(),borrow.getIssueDate());
    //         borrowlists.add(borrowView);
    //     }
    //     return borrowlists;
